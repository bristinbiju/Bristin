                    ...
                    return (
                        <TiltCard key={i} className="h-[300px]">
                            <div className="relative h-full w-full rounded-2xl overflow-hidden border border-white/10 bg-white/5 backdrop-blur-md p-6 flex flex-col justify-between group">
                                <div className={`absolute top-0 right-0 w-24 h-24 bg-gradient-to-br ${service.color} opacity-20 blur-2xl -translate-y-10 translate-x-10 group-hover:translate-x-0 group-hover:translate-y-0 transition-transform duration-500`} />

                                <div className="bg-white/10 w-12 h-12 rounded-lg flex items-center justify-center mb-4 border border-white/5">
